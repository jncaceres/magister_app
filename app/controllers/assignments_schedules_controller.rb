class AssignmentsSchedulesController < ApplicationController
  before_action :set_assignment_schedule, only: [:show, :edit, :update, :destroy, :assign_second_stage_corrections, :assign_third_stage_corrections]
